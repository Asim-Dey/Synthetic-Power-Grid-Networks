...
CLC10 <- read.table("C:/Users/asimi/OneDrive/Synthentic Network/Random Graph Model/Python/CLC simulated data/N_Italy_10.txt",header=TRUE)
...
### Two Parameter 
KL11<-c(0.3547694,0.4208885,0.4478223,0.3554197,0.4332846,0.4586121,0.4061122,0.4009741,0.4277401)
mean(KL11) # 0.4117359
sd(KL11)  # 0.03685783


### One Parameter 
KL11<-c(0.524,0.334,0.396,0.422,0.355,0.385,0.395,0.335,0.414,0.432)
mean(KL11) # 0.399
sd(KL11)  # 0.056
