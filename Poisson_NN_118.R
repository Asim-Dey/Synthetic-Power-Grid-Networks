...
CLC10 <- read.table("C:/Users/asimi/OneDrive/Synthentic Network/Random Graph Model/Python/Poisson simulated data/IEEE118_PoissonNN_10.txt",header=TRUE)
...
KL12<-c(0.2829951,0.2197131, 0.207658,0.2106556,0.1943059,0.1500672,0.223948,0.162941,0.2104796,0.2004671)
