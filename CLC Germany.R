...
CLC10 <- read.table("C:/Users/asimi/OneDrive/Synthentic Network/Random Graph Model/Python/CLC simulated data/N_Germany_10.txt",header=TRUE)
...
## Two parameter
KL12<-c(0.353691,0.3871139, 0.308842,0.3391355,0.3811557,0.295162,0.3664658,0.3605351,0.4536767,0.3012997)
mean(KL12) #  0.3547077
sd(KL12)   #  0.04768185
...
### One parameter 
#KL11<-c(0.339,0.431,0.402, 0.325,0.407,0.336,0.353,0.343,0.332,0.359)
#mean(KL11) # 0.3627
#sd(KL11)  # 0.0369
